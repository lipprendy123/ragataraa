      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center" variants={fadeInUp}>
          ...
          <motion.div variants={fadeInUp}>
            <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-6">Why Choose Ragatara?</h2>
            <p className="text-xl text-gray-600 leading-relaxed mb-8">
              Ragatara is dedicated to delivering premium animation content with uncompromising quality. We bring
              together the world's finest animators and storytellers to create magical experiences that captivate
              audiences of all ages.
            </p>

            <div className="space-y-4">
              {features.map((feature) => (
                <motion.div key={feature.title} className="flex gap-4" whileHover={{ x: 4 }} variants={fadeInUp}>
          ...
          {/* Right Image */}
          <motion.div className="rounded-lg overflow-hidden shadow-lg" whileHover={{ scale: 1.02 }}>
            <img
