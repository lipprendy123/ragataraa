...
export default function SeriesDetail() {
  ...
  return (
    <motion.div className="min-h-screen bg-white" initial="hidden" animate="visible" variants={fadeInUp}>
      <Navbar />

      <motion.div className="max-w-6xl mx-auto px-4 py-8 sm:py-12" variants={fadeInUp}>
        {/* Back Button */}
        <motion.button
          onClick={() => navigate("/")}
        ...
        {/* Series Header */}
        <motion.div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12" variants={fadeInUp}>
          {/* Poster */}
          ...
          <motion.div className="md:col-span-2" variants={fadeInUp}>
            <motion.h1 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-4" variants={fadeInUp}>
              {series.title}
            </motion.h1>
            ...
            <motion.div className="flex flex-wrap gap-3 mb-6" variants={fadeInUp}>
              ...
              <span className="px-4 py-1 bg-blue-100 text-blue-700 rounded-full text-sm font-medium">HD Quality</span>
            </motion.div>
            ...
            <motion.div className="bg-gray-50 p-4 rounded-lg" variants={fadeInUp}>
              <p className="text-sm text-gray-600">
                <span className="font-semibold text-gray-900">Director:</span> {series.director}
              </p>
              <p className="text-sm text-gray-600 mt-2">
                <span className="font-semibold text-gray-900">Release Year:</span> {series.year}
              </p>
            </motion.div>
          </motion.div>
        </motion.div>
            ...
            {series.episodes.map((episode) => (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <p className="text-xs text-gray-500 mt-2">{episode.duration}</p>
                </div>
              </motion.div>
            ))}
          </motion.div>
